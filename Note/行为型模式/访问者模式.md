...
封装一些作用于某种数据结构中的各元素的操作，它可以**在不改变这个数据结构的前提下定义作用于这些元素的新的操作**。
...
![20220512140321](https://raw.githubusercontent.com/senluoye/BadGallery/master/image/20220512140321.png)
...
![20220512141018](https://raw.githubusercontent.com/senluoye/BadGallery/master/image/20220512141018.png)
...
![20220512141624](https://raw.githubusercontent.com/senluoye/BadGallery/master/image/20220512141624.png)
...
![20220512142744](https://raw.githubusercontent.com/senluoye/BadGallery/master/image/20220512142744.png)

**双分派实现动态绑定的本质，就是在重载方法委派的前面加上了继承体系中覆盖(传不同的 this)的环节，由于覆盖是动态的，所以重载就是动态的了。**
