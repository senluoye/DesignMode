...
![20220511201124](https://raw.githubusercontent.com/senluoye/BadGallery/master/image/20220511201124.png)
...
![20220511201544](https://raw.githubusercontent.com/senluoye/BadGallery/master/image/20220511201544.png)
...
> JDK 中把 Iterator 抽象成了接口，通过泛型传入对应实体类，从而达到实现迭代器的目的
...
- ArrayList：具体的聚合类
- Iterator：抽象迭代器
- list.iterator()：返回的是实现了 `Iterator` 接口的具体内部迭代器类的实例
